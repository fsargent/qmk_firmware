...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[BASE] = LAYOUT(
		...
		KC_LSFT,			KC_Z,	KC_X,	KC_C,	KC_V,	KC_B,	DF(CMK),						TO(WIN),	KC_N,		KC_M,		KC_COMM,	KC_DOT,		KC_SLSH,	MT(MOD_LSFT,KC_BSLS),
		MT(MOD_LCTL, KC_LBRC),	MT(MOD_LALT, KC_RBRC),	LT(SYM,KC_DEL), MO(NAV),	CMD_T(KC_BSPC),	KC_SPC,		KC_ENT,	MT(MOD_LGUI, KC_DEL),	MT(MOD_LALT, KC_MINS), 	MT(MOD_LCTL, KC_EQL)
	),
	[CMK] = LAYOUT(
		KC_GRV,				KC_1,	KC_2,	KC_3,	KC_4,	KC_5,											KC_6,		KC_7,		KC_8,		KC_9,		KC_0,		KC_MINS,
		...
		KC_LSFT,			KC_Z,	KC_X,	KC_C,	KC_D,	KC_V,	DF(BASE),					TO(WIN),	KC_K,		KC_H,		KC_COMM,	KC_DOT,		KC_SLSH,	MT(MOD_LSFT,KC_BSLS),
	...
	[WIN] = LAYOUT(
		...
		MT(MOD_LGUI, KC_LBRC),_______,_______,MO(WINNAV),	CTL_T(KC_BSPC),				_______,	_______,_______,_______,_______
	),
	[GAME] = LAYOUT(
		...
		KC_LCTL,		KC_LALT,	MO(NAV),	KC_LCTL,	KC_SPC,					KC_BSPC,	LT(NAV, KC_ENT),MT(MOD_LGUI,KC_DEL),MT(MOD_LALT, KC_MINS),MT(MOD_LCTL, KC_EQL)
	),
	[SYM]	=	LAYOUT(
		// C(G(KC_SPC)) is the OS X Emoji Editor
		C(G(KC_SPC)),	KC_F1,		KC_F2,		KC_F3,		KC_F4,		KC_F5,										KC_F6,		KC_F7,		KC_F8,		KC_F9,		KC_F10,		KC_F11,
		_______,		KC_NO,		RGB_TOG,	RGB_HUI,	RGB_SAI,	RGB_VAI,									RGB_MOD,	RGB_MODE_SWIRL,		RGB_MODE_RAINBOW,		RGB_MODE_PLAIN,		RESET,		KC_F12,
	...
	[NAV]=LAYOUT(
		C(KC_GRV),				G(KC_SLSH),	KC_NO,		KC_WH_U,	KC_WH_R,	G(KC_ENT),							RGB_MOD,	KC_MPRV,	KC_MPLY,	KC_MNXT,	KC_MUTE,	KC_EQL,
		CMD_TAB,				A(KC_BSPC),	KC_PGUP,	KC_UP,		KC_ENT,		A(KC_DEL),							RGB_RMOD,	KC_WH_U,	KC_MS_U,	KC_WH_R,	KC_WH_R,	KC_EQL,
		...
		_______,	_______,	_______,	_______,	_______,										KC_BTN1,	KC_BTN2,	KC_BTN3,	MT(MOD_LALT, KC_MINS), 	MT(MOD_LCTL, KC_EQL)
	),
	[WINNAV]=LAYOUT(
		C(KC_GRV),	MEH(2),		KC_NO,		KC_WH_U,	KC_WH_R,	G(KC_ENT),							RGB_MOD,	KC_MPRV,	KC_MPLY,	KC_MNXT,	KC_MUTE,	KC_EQL,
		ALT_TAB, 	C(KC_BSPC),	KC_PGUP,	KC_UP,		KC_ENT,		C(KC_DEL),							RGB_RMOD,	KC_WH_U,	KC_MS_U,	KC_WH_R,	KC_NO,		KC_EQL,
		KC_LGUI,	C(KC_LEFT), KC_LEFT,	KC_DOWN,	KC_RGHT,	C(KC_RGHT),							KC_BTN3,	KC_MS_L,	KC_MS_D,	KC_MS_R,	KC_NO,		KC_LGUI,
		KC_LSFT,	KC_HOME,	KC_PGDN,	KC_SPC,		KC_SPC,		KC_END,	G(KC_ENT),     	TG(GAME),	KC_WH_D,	KC_WH_L,	KC_WH_R,	KC_NO,	    KC_BSLS,	KC_DEL,
		_______,	_______,	_______,	_______,	_______,							KC_BTN1,	KC_BTN2,	KC_BTN3,	MT(MOD_LALT, KC_MINS), 	MT(MOD_LCTL, KC_EQL)
	)
};
...
combo_t key_combos[] = {
    ...
    [COLEMAK] = COMBO_ACTION(mcommdotslsh_combo),
