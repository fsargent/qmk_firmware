 ...
 */
  ...
  [BASE] = LAYOUT(
    ...
    KC_LSFT,            KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, S(G(KC_A)),                  KC_MPLY, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
                        KC_LALT, KC_LCTL, MO(SYM), CMD_T(KC_BSPC), LT(NAV, KC_TAB),   LT(SYM, KC_ENT),  KC_SPC,  LT(NAV,KC_ESC),  C(G(KC_SPC)), TD(LAYR)
  ),
  [WIN] = LAYOUT(
  ...
  [NAV] = LAYOUT(
    C(KC_GRV),  KC_WH_L,       KC_WH_D,         KC_WH_U,        KC_WH_R,        LGUI(KC_BSPC),                     KC_VOLU,    KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_CAPS,
    KC_TAB,    LGUI(KC_LEFT), LGUI(KC_DOWN),   LGUI(KC_UP),    LGUI(KC_RGHT),  KC_ENT,                            KC_VOLD,    KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_SCROLLLOCK,
    KC_LALT,    KC_LEFT,       KC_DOWN,         KC_UP,          KC_RGHT,        KC_SPC,                            KC_MS_BTN4, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_PAUSE,
    KC_LSFT,    S(A(KC_LEFT)), LALT(KC_LEFT),   LALT(KC_RGHT),  S(A(KC_RGHT)), LALT(KC_BSPC), MEH(KC_G),      TO(3),  KC_MS_BTN5, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_INSERT,
                               KC_RST,          _______,        _______,        _______,      _______,     KC_MS_BTN1,KC_MS_BTN2,KC_MS_BTN3, _______, _______
  ),
  [NUM] = LAYOUT(
  ...
  [SYM] = LAYOUT(
    ...
    _______,    KC_BSLS,  KC_UNDS,    KC_PLUS,KC_LBRC,KC_RBRC,_______,  TO(0),  KC_PMNS,  KC_P1,    KC_P2,    KC_P3,    KC_PENT,   KC_NLCK,
                          KC_RST,     _______,_______,_______,_______,  _______,_______,  _______,  _______,  _______
  ),
   [GAME] = LAYOUT(
    ...
    MEH(KC_NO),MEH(KC_NO), KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_QUOT,
    KC_LSFT,   KC_LSFT,    KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  MEH(KC_F13),     TO(2),KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
